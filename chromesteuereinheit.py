    ...
    if Videobeschreibungaktionvarable == "Wahr":
        try:
                ...
                try:
                    ...
                    logdatei = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Logdatei.txt", 'a', encoding='utf8')
                    logdatei.write("Chromedatei.Eingabe Error falsche XPATH\n"+str(datetime.datetime.now().strftime("%d.%m.%Y Datum\n%M.%H Uhr\n")))
                    logdatei.close()
                    Livestreamänderungersatz = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Livestreamänderungersatz.txt", 'r', encoding='utf8')
                    Livestreamänderungersatz = Livestreamänderungersatz.read()
                    eingabe = driver.find_element(By.ID,Livestreamänderungersatz)
                    eingabe.click()
                try:
                    Öffnen_Einstellungenstream = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Öffnen_Einstellungenstream.txt", 'r',    encoding='utf8')
                    ...
                    logdatei.write("Chromedatei.Eingabe Error falsche XPATH\n"+str(datetime.datetime.now().strftime("%d.%m.%Y Datum\n%M.%H Uhr\n")))
                    logdatei.close()
                    Öffnen_Einstellungenstreamersatz = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Öffnen_Einstellungenstreamersatz.txt", 'r',    encoding='utf8')
                ...
                time.sleep(2)
                try:
                    Texteingabeclick = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Texteingabe.txt", 'r',    encoding='utf8')
                ...
                if len(Haupt.Schlusslied.Liednummerfest) > 0:
                    if len(Haupt.Schlusslied.Liedversefest) >= 1:
                        Texteingabe1 = str(f"S {Haupt.Schlusslied.Buch} {Haupt.Schlusslied.Liednummerfest} Vers {Haupt.Schlusslied.Liedversefest} \n{Haupt.Schlusslied.Dateiliedtext}\n\n\n")
                        Texteingabe = Texteingabe + Texteingabe1
                    else:
                        Texteingabe1 = str("S " + Haupt.Schlusslied.Buch + " " + Haupt.Schlusslied.Liednummerfest + "\n" + str(Haupt.Schlusslied.Dateiliedtext) + "\n\n\n")
                        Texteingabe = Texteingabe + Texteingabe1
                Textwortauslesen1 = open(f"C:\\Users\\{Dateiort}\\Desktop\\Lieder\\Textwort.txt", 'r', encoding='utf8')
                Textwortübergabe = Textwortauslesen1.read()
                Textwortauslesen1.close()
                eingabe3.send_keys(Textwortübergabe +"\n\n\n"+ Texteingabe)
                try:
                    Texteingabebestätigen = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Texteingabebestätigen.txt", 'r',    encoding='utf8')
                    Texteingabebestätigen = Texteingabebestätigen.read()
                    eingabe4 = driver.find_element(By.XPATH,Texteingabebestätigen)
                    eingabe4.click()
                except:
                    Texteingabebestätigen = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Texteingabebestätigenersatz.txt", 'r',    encoding='utf8')
                    Texteingabebestätigen = Texteingabebestätigen.read()
                    eingabe4 = driver.find_element(By.XPATH,Texteingabebestätigen)
                    eingabe4.click()
                time.sleep(1)
                try:
                    Texteingabeende = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Texteingabeende.txt", 'r',    encoding='utf8')
                    Texteingabeende = Texteingabeende.read()
                    eingabe5 = driver.find_element(By.XPATH,Texteingabeende)
                    eingabe5.click()
                except:
                    Texteingabeendeersatz = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Texteingabeendeersatz.txt", 'r',    encoding='utf8')
    ...
    if Chromöffnen == "Wahr":
        if Streamüperprüfen:
            if Videobeschreibungaktionvarable == "Wahr":
                ...
                Stream_erstellen = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen.txt", 'r', encoding='utf8')
                Stream_erstellen = Stream_erstellen.read()
                eingabe8 = driver.find_element(By.XPATH,Stream_erstellen)
                eingabe8.click()
                time.sleep(2)
                Stream_erstellen_details = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_details.txt", 'r', encoding='utf8')
                Stream_erstellen_details = Stream_erstellen_details.read()
                eingabe9 = driver.find_element(By.XPATH,Stream_erstellen_details)
                eingabe9.click()
                time.sleep(2)
                Stream_erstellen_anpassen = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_anpassen.txt", 'r', encoding='utf8')
                Stream_erstellen_anpassen = Stream_erstellen_anpassen.read()
                eingabe10 = driver.find_element(By.XPATH,Stream_erstellen_anpassen)
                eingabe10.click()
                time.sleep(2)
                Stream_erstellen_sichtbarkeit = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_sichtbarkeit.txt", 'r', encoding='utf8')
                ...
                eingabe11.click()
                time.sleep(2)
                Stream_erstellen_sichtbarkeit_nicht_gelistet = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_sichtbarkeit_nicht_gelistet.txt", 'r', encoding='utf8')
                ...
                eingabe111.click()
                time.sleep(1)
                Stream_erstellen_eingabe_datum = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_eingabe_datum.txt", 'r', encoding='utf8')
                ...
                eingabe12.click()
                time.sleep(2)
                Stream_erstellen_datum = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_datum.txt", 'r', encoding='utf8')
                ...
                time.sleep(2)
                Stream_erstellen_hintergrund = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_hintergrund.txt", 'r', encoding='utf8')
                ...
                eingabe14.click()
                time.sleep(2)
                Stream_erstellen_uhrzeit = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_uhrzeit.txt", 'r', encoding='utf8')
                ...
                time.sleep(2)
                Stream_erstellen_sichtbarkeit_fertig = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_sichtbarkeit_fertig.txt", 'r', encoding='utf8')
                ...
                eingabe18.click()
                time.sleep(1)
                Stream_erstellen_einstellungen = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_einstellungen.txt", 'r', encoding='utf8')
                ...
                eingabe19.click()
                time.sleep(1)
                Stream_erstellen_kopieren = open(f"C:\\Users\\{Haupt.Dateiort}\\Desktop\\Lieder\\Stream_erstellen_kopieren.txt", 'r', encoding='utf8')
